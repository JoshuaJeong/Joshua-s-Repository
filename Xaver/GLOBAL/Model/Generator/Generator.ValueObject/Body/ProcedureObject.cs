...
namespace Generator.ValueObject
{
    ...
    public class ProcedureObject : ModelBase
    {
        ...
        //    set { if (procedureName != value) { procedureName = value; OnPropertyChanged("ProcedureName"); } }
        //}
        ...
        //    set { if (procedureCode != value) { procedureCode = value; OnPropertyChanged("ProcedureCode"); } }
        //}
        #endregion
        #endregion
